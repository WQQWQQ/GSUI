        ...
        <nav>
            <ul>
              ...
              <li><router-link to="/scroll">Scroll</router-link></li> -->
                ...
                <li><router-link to="/gs-tabs">GsTabs</router-link></li>
                <li><router-link to="/gs-modal">GsModal</router-link></li>
                <li><router-link to="/gs-input">GsInput</router-link></li>
                <li><router-link to="/gs-page">GsPage</router-link></li>
                <li><router-link to="/gs-select">GsSelect</router-link></li>
                <li><router-link to="/gs-button">GsButton</router-link></li>
                <li><router-link to="/gs-checkbox">GsCheckbox</router-link></li>
                <li><router-link to="/gs-calendar">GsCalendar</router-link></li>
            </ul>
        </nav>
