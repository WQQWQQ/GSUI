...
const router = new VueRouter({
    ...
    routes: [{
        ...
        {
            path: '/gs-table',
            component: (resolve) => require(['./routers/gs-table.vue'], resolve)
        },
        {
            path: '/gs-tabs',
            component: (resolve) => require(['./routers/gs-tabs.vue'], resolve)
        },
        {
            path: '/gs-menu',
            component: (resolve) => require(['./routers/gs-menu.vue'], resolve)
        },
        {
            path: '/gs-modal',
            component: (resolve) => require(['./routers/gs-modal.vue'], resolve)
        },
        {
            path: '/gs-page',
            component: (resolve) => require(['./routers/gs-page.vue'], resolve)
        },
        {
            path: '/gs-input',
            component: (resolve) => require(['./routers/gs-input.vue'], resolve)
        },
        {
            path: '/gs-button',
            component: (resolve) => require(['./routers/gs-button.vue'], resolve)
        },
        {
            path: '/gs-checkbox',
            component: (resolve) => require(['./routers/gs-checkbox.vue'], resolve)
        },
        {
            path: '/gs-calendar',
            component: (resolve) => require(['./routers/gs-calendar.vue'], resolve)
        },
        {
            path: '/gs-select',
            component: (resolve) => require(['./routers/gs-select.vue'], resolve)
        }
