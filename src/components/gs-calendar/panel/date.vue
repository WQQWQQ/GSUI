        ...
        <div :class="[prefixCls + '-body']">
            <div :class="[datePrefixCls + '-header']"
              v-show="currentView !== 'time'">
                ...
                <span :class="iconBtnCls('prev')"
                  @click="changeMonth(-1)"
                  v-show="currentView === 'date'">
                    <i class="ivu-icon ivu-icon-ios-arrow-left"></i>
                </span>
                <date-panel-label :date-panel-label="datePanelLabel"
            ...
            <TimeSelector v-if="showTime" :hour="hour"
              :minute="minute"
              :second="second"
              @on-change="handleChange"
              @on-pick-click="handlePickClick"></TimeSelector>
            <Confirm
              :is-time="isTime"
              @on-pick-toggle-time="handleToggleTime"
              @on-pick-clear="handlePickClear"
              @on-pick-today="handlePickToday"
...
<script>
    ...
    import TimeSelector from '../base/time-selector.vue';
