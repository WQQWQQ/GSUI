            ...
            <div :class="[prefixCls + '-content', prefixCls + '-content-left']" v-show="!isTime">
                <div :class="[datePrefixCls + '-header']" v-show="leftCurrentView !== 'time'">
                    <span
                        ...
                        @click="prevYear('left')"><i class="ivu-icon ivu-icon-ios-arrow-left"></i></span>
                    <span
                        :class="iconBtnCls('prev')"
                        @click="prevMonth"
                        v-show="leftCurrentView === 'date'"><i class="ivu-icon ivu-icon-ios-arrow-left"></i></span>
                    <date-panel-label
                    ...
                    <span
                        ...
                        @click="nextYear('left')"
                        v-show="leftCurrentView === 'year' || leftCurrentView === 'month'"><i class="ivu-icon ivu-icon-ios-arrow-right"></i></span>
                </div>
                <date-table
            ...
            <div :class="[prefixCls + '-content', prefixCls + '-content-right']" v-show="!isTime">
                <div :class="[datePrefixCls + '-header']" v-show="rightCurrentView !== 'time'">
                     <span
                         ...
                         v-show="rightCurrentView === 'year' || rightCurrentView === 'month'"><i class="ivu-icon ivu-icon-ios-arrow-left"></i></span>
                    <date-panel-label
                    ...
                    <span
                        :class="iconBtnCls('next', '-double')"
                        @click="nextYear('right')"><i class="ivu-icon ivu-icon-ios-arrow-right"></i></span>
                    <span
                        :class="iconBtnCls('next')"
                        @click="nextMonth"
                        v-show="rightCurrentView === 'date'"><i class="ivu-icon ivu-icon-ios-arrow-right"></i></span>
                </div>
                <date-table
...
<script>
    ...
    export default {
        name: 'DatePicker',
        mixins: [ Mixin, Locale ],
        components: { DateTable, YearTable, MonthTable, TimePicker, Confirm, datePanelLabel },
        data () {
            return {
                prefixCls: prefixCls,
