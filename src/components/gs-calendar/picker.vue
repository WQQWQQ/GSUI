...
<script>
    import GsInput from '../gs-input/gs-input.vue';
    ...
    export default {
        ...
        props: {
            ...
            // type: {
            //     validator(value) {
            //         return oneOf(value, ['datetime', 'date', 'year','month']);
            //     },
            //     default:'datetime'
            // },
            format: {
        ...
        methods: {
            ...
            handleClear() {
                ...
                if(!this.picker) {
                    ...
                    this.picker.hour = this.picker.minute = this.picker.second = 0;
                }
            },
            showPicker() {
                if(!this.picker) {
                    ...
                    this.picker.$on('on-pick', (date, visible = false) => {
                        ...
                        if(date) {
                            this.picker.hour = date.getHours();
                            this.picker.minute = date.getMinutes();
                            this.picker.second = date.getSeconds();
                        }
                    ...
                    this.picker.$on('on-pick-today', () => {
                        let date = new Date();
                        this.picker.hour = date.getHours();
                        this.picker.minute = date.getMinutes();
                        this.picker.second = date.getSeconds();
                        this.picker.value = this.currentValue = this.formattingDate(date);
                        this.emitChange(date);
                        this.visible = false;
                        this.$emit('on-today');
                    });
